...
class Invitebutton(discord.ui.View):
    ...
    # features of the button
    @discord.ui.button(label="Second", style=discord.ButtonStyle.green)
    async def hehe(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("HEHEHEHHE :wave:", ephemeral=True)
...
bot.run('MTE1MTkyNDYxNTk5MjU4MjE1NA.GBAKbp.U5d2HtAnsp4-OCGjf2m6KNzt1t6yY2RC13Og_s')
